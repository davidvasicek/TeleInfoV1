...
public class TeacherSelectBottomSheetDialog extends BottomSheetDialogFragment {
    ...
    public TeacherSelectBottomSheetDialog() {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.rozvrh_rozvrh_smazat, null);
        ...
        mMainTeachersAdapter = new MainTeachersAdapter(mMainLightsList_original, getContext(), getChildFragmentManager());
