...
public class ClassroomSelectBottomSheetDialog extends BottomSheetDialogFragment {
    ...
    public ClassroomSelectBottomSheetDialog(List<String> colors, int columns, String colorSelected) {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.rozvrh_dialog_bottom_sheet_dialog_select_classroom, null);
...
//    }
    ...
    public class ClassroomSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new ColorViewItem(LayoutInflater.from(parent.getContext()).inflate(R.layout.rozvrh_dialog_bottom_sheet_dialog_select_classroom_adapter_item,parent,false));
        }
            ...
            colorViewItem.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("action", "weeklyBySchoolroom");
                     intent.putExtra("schoolroom", color);
