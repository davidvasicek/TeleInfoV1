...
public class BottomSheetDialogTeacherCard extends BottomSheetDialogFragment {


    public BottomSheetDialogTeacherCard() {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.rozvrh_bottom_sheet_dialog_teacher_card, null);
